...
```{r}
m07<- lmer(lngap_perc~year+mujer+edad+educacion+ess+(1|idencuesta),data=long01a)
m08<- lmer(lngap_just~year+mujer+edad+educacion+ess+lngap_perc+(1|idencuesta),data=long01a)
```

```{r}
plot_model(m07,type = "pred",terms = "year")
plot_model(m08,type = "pred",terms = "year")
```
